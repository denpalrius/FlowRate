...
(function (ThingSpeak) {
    ...
    var AppModule = (function () {
        function AppModule() {
            ...
            ngFlowRate.controller("HomeController", ["$scope", "$rootScope", "$timeout", "$location", "$cookies", "FirebaseService", "MapService", "$mdSidenav", ThingSpeak.Controllers.HomeController]);
...
(function (ThingSpeak) {
    ...
    (function (Controllers) {
        ...
        var HomeController = (function () {
            function HomeController($scope, $rootScope, $timeout, $location, $cookies, FirebaseService, MapService, $mdSidenav) {
                this.$scope = $scope;
            ...
            HomeController.prototype.uploadSensorData = function () {
                var that = this;
                var sensorArray = [
                    {
                        "id": "0005AMB",
                ...
                sensorArray.forEach(function (sensor) {
                    that.FirebaseService.write(ThingSpeak.Configs.AppConfig.firebaseRefs.sensors, sensor);
                });
            };
            HomeController.prototype.toggleSideNav = function (navID) {
                var that = this;
